...
| :--- | :--- | :--- |
| **1** | **Revenue Deceleration & Shifting Seasonality**<br>• Annual growth slowed from +2.04% (2020) to +0.17% (2021).<br>• Seasonal peaks shifted earlier (from August toward June).<br>• Consistent revenue troughs occur in September. | **Campaign Timing & Seasonality Optimization**<br>• Review and replicate past successful promotional campaigns from peak mid-year periods.<br>• Launch targeted recovery campaigns in **September** to counteract the annual revenue trough. |
